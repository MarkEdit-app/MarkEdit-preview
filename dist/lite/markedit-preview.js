...
`:`<br>
`:`
`};re.text=function(e,n){return me(e[n].content)};re.html_block=function(e,n){return e[n].content};re.html_inline=function(e,n){return e[n].content};function He(){this.rules=Fn({},re)}He.prototype.renderAttrs=function(n){let t,r,o;if(!n.attrs)return"";for(o="",t=0,r=n.attrs.length;t<r;t++)o+=" "+me(n.attrs[t][0])+'="'+me(n.attrs[t][1])+'"';return o};He.prototype.renderToken=function(n,t,r){const o=n[t];let u="";if(o.hidden)return"";o.block&&o.nesting!==-1&&t&&n[t-1].hidden&&(u+=`

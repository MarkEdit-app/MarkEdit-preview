...
`,Be={github:{light:C0,dark:v0},cobalt:{dark:E0},dracula:{dark:D0},minimal:{light:A0,dark:F0},"night-owl":{dark:S0},"rose-pine":{light:T0,dark:M0},solarized:{light:z0,dark:I0},synthwave84:{dark:P0},"winter-is-coming":{light:B0,dark:R0},xcode:{light:L0,dark:O0}};function U0(e="auto"){const u=Be[Bn]??Be.github,n=u.light??u.dark,t=u.dark??u.light,r=Du(n)??"#ffffff",o=Du(t)??"#0d1117";return[".markdown-body { padding: 25px; }",...$e(e,`body { background: ${r}; }`,`body { background: ${o}; }`)].join(`
`)}function Rn(e="auto"){const u=Be[Bn]??Be.github,n=u.light??u.dark,t=u.dark??u.light;return[_0,...$e(e,n,t)].join(`
`)}function Z0(e="auto"){return[q0,...$e(e,j0,N0)].join(`
`)}function Ln(e="auto"){return[$0,...$e(e,H0,G0)].join(`

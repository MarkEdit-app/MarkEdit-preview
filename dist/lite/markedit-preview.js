...
`:`<br>
`:`
`};ke.text=function(e,n){return Ie(e[n].content)};ke.html_block=function(e,n){return e[n].content};ke.html_inline=function(e,n){return e[n].content};function rn(){this.rules=eu({},ke)}rn.prototype.renderAttrs=function(n){let u,r,o;if(!n.attrs)return"";for(o="",u=0,r=n.attrs.length;u<r;u++)o+=" "+Ie(n.attrs[u][0])+'="'+Ie(n.attrs[u][1])+'"';return o};rn.prototype.renderToken=function(n,u,r){const o=n[u];let a="";if(o.hidden)return"";o.block&&o.nesting!==-1&&u&&n[u-1].hidden&&(a+=`

...
`:`<br>
`:`
`};Oe.text=function(e,t){return rt(e[t].content)};Oe.html_block=function(e,t){return e[t].content};Oe.html_inline=function(e,t){return e[t].content};function Pt(){this.rules=Gn({},Oe)}Pt.prototype.renderAttrs=function(t){let n,r,o;if(!t.attrs)return"";for(o="",n=0,r=t.attrs.length;n<r;n++)o+=" "+rt(t.attrs[n][0])+'="'+rt(t.attrs[n][1])+'"';return o};Pt.prototype.renderToken=function(t,n,r){const o=t[n];let u="";if(o.hidden)return"";o.block&&o.nesting!==-1&&n&&t[n-1].hidden&&(u+=`
...
`)}
</tbody>`}function oo(e,t){if(e==null)return"";if(e instanceof Date)return t(qf(e));if(Array.isArray(e))return e.every($f)?e.map(r=>oo(r,t)).join(", "):`<ul>${e.map(r=>`<li>${oo(r,t)}</li>`).join("")}</ul>`;if(typeof e=="object"){const n=wa(e,t);return n===""?"":`<table>${n}</table>`}return t(String(e))}function qf(e){if(Number.isNaN(e.getTime()))return"";const t=e.toISOString();return t.endsWith("T00:00:00.000Z")?t.slice(0,10):t}function $f(e){if(e==null||e instanceof Date)return!0;const t=typeof e;return t==="string"||t==="number"||t==="boolean"||t==="bigint"}const _o={rootValueKey:"extension.markeditPreview",defaultModes:["edit","side-by-side","preview","syntax-hidden"],defaultPreset:"default"},Uf=Ht(I.MarkEdit.userSettings),xe=Ht(Uf[_o.rootValueKey]),va=Ht(xe.changeMode),_a=Ht(xe.markdownIt),jf=hn(xe.syncScroll);hn(xe.hidePreviewButtons);hn(xe.syntaxAutoDetect,!1);const Gf=hn(xe.imageHoverPreview,!1),Wf=hn(xe.inlineImages,!1),Ea=Array.isArray(xe.inlineRendering)?xe.inlineRendering.filter(e=>e==="image"||e==="table"||e==="math"||e==="mermaid"):Wf?["image","table","math","mermaid"]:["table","math","mermaid"],nr=xe.themeName??"github",Aa=nr==="none",Br=xe.styledHtmlColorScheme??xe.styledHtmlTheme??"auto";xe.mathDelimiters;const Vf=va.modes??_o.defaultModes,Gu=Ht(va.hotKey),Zf=_a.preset??_o.defaultPreset,Yf=Ht(_a.options);function Ht(e,t={}){return e??t}function hn(e,t=!0){return e??t}const Sa=`.markdown-body {
  --base-size-16: 1rem;
  --base-size-24: 1.5rem;
  --base-size-4: 0.25rem;
  --base-size-40: 2.5rem;
...
`,Nt={github:{light:Kf,dark:Xf},cobalt:{dark:Jf},dracula:{dark:Qf},minimal:{light:eh,dark:th},"night-owl":{dark:nh},"rose-pine":{light:rh,dark:oh},solarized:{light:uh,dark:ih},synthwave84:{dark:ah},"winter-is-coming":{light:ch,dark:sh},xcode:{light:lh,dark:dh}};function bh(e="auto"){if(Aa)return"";const t=Nt[nr]??Nt.github,n=t.light??t.dark,r=t.dark??t.light,o=su(n)??"#ffffff",u=su(r)??"#0d1117";return[".markdown-body { padding: 25px; }",...Eo(e,`body { background: ${o}; }`,`body { background: ${u}; }`)].join(`
...
`);const t=Nt[nr]??Nt.github,n=t.light??t.dark,r=t.dark??t.light;return[Sa,...Eo(e,n,r)].join(`
...
${e}
</div>`,t(bh(Br)),t(Ta(Br)),t(yh(Br)),t(Da()),"</body></html>"].join(`

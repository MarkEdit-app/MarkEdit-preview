...
`}function Ea(e,u,n,t,r){let o=r.rules.footnote_anchor_name(e,u,n,t,r);return e[u].meta.subId>0&&(o+=`:${e[u].meta.subId}`),` <a href="#fnref${o}" class="footnote-backref">↩︎</a>`}function Da(e){const u=e.helpers.parseLinkLabel,n=e.utils.isSpace;e.renderer.rules.footnote_ref=xa,e.renderer.rules.footnote_block_open=wa,e.renderer.rules.footnote_block_close=va,e.renderer.rules.footnote_open=_a,e.renderer.rules.footnote_close=Ca,e.renderer.rules.footnote_anchor=Ea,e.renderer.rules.footnote_caption=ya,e.renderer.rules.footnote_anchor_name=ka;function t(a,s,d,p){const c=a.bMarks[s]+a.tShift[s],h=a.eMarks[s];if(c+4>h||a.src.charCodeAt(c)!==91||a.src.charCodeAt(c+1)!==94)return!1;let l;for(l=c+2;l<h;l++){if(a.src.charCodeAt(l)===32)return!1;if(a.src.charCodeAt(l)===93)break}if(l===c+2||l+1>=h||a.src.charCodeAt(++l)!==58)return!1;if(p)return!0;l++,a.env.footnotes||(a.env.footnotes={}),a.env.footnotes.refs||(a.env.footnotes.refs={});const f=a.src.slice(c+2,l-2);a.env.footnotes.refs[`:${f}`]=-1;const b=new a.Token("footnote_reference_open","",1);b.meta={label:f},b.level=a.level++,a.tokens.push(b);const m=a.bMarks[s],g=a.tShift[s],k=a.sCount[s],y=a.parentType,x=l,w=a.sCount[s]+l-(a.bMarks[s]+a.tShift[s]);let v=w;for(;l<h;){const C=a.src.charCodeAt(l);if(n(C))C===9?v+=4-v%4:v++;else break;l++}a.tShift[s]=l-x,a.sCount[s]=v-w,a.bMarks[s]=x,a.blkIndent+=4,a.parentType="footnote",a.sCount[s]<a.blkIndent&&(a.sCount[s]+=a.blkIndent),a.md.block.tokenize(a,s,d,!0),a.parentType=y,a.blkIndent-=4,a.tShift[s]=g,a.sCount[s]=k,a.bMarks[s]=m;const _=new a.Token("footnote_reference_close","",-1);return _.level=--a.level,a.tokens.push(_),!0}function r(a,s){const d=a.posMax,p=a.pos;if(p+2>=d||a.src.charCodeAt(p)!==94||a.src.charCodeAt(p+1)!==91)return!1;const c=p+2,h=u(a,p+1);if(h<0)return!1;if(!s){a.env.footnotes||(a.env.footnotes={}),a.env.footnotes.list||(a.env.footnotes.list=[]);const l=a.env.footnotes.list.length,f=[];a.md.inline.parse(a.src.slice(c,h),a.md,a.env,f);const b=a.push("footnote_ref","",0);b.meta={id:l},a.env.footnotes.list[l]={content:a.src.slice(c,h),tokens:f}}return a.pos=h+1,a.posMax=d,!0}function o(a,s){const d=a.posMax,p=a.pos;if(p+3>d||!a.env.footnotes||!a.env.footnotes.refs||a.src.charCodeAt(p)!==91||a.src.charCodeAt(p+1)!==94)return!1;let c;for(c=p+2;c<d;c++){if(a.src.charCodeAt(c)===32||a.src.charCodeAt(c)===10)return!1;if(a.src.charCodeAt(c)===93)break}if(c===p+2||c>=d)return!1;c++;const h=a.src.slice(p+2,c-1);if(typeof a.env.footnotes.refs[`:${h}`]>"u")return!1;if(!s){a.env.footnotes.list||(a.env.footnotes.list=[]);let l;a.env.footnotes.refs[`:${h}`]<0?(l=a.env.footnotes.list.length,a.env.footnotes.list[l]={label:h,count:0},a.env.footnotes.refs[`:${h}`]=l):l=a.env.footnotes.refs[`:${h}`];const f=a.env.footnotes.list[l].count;a.env.footnotes.list[l].count++;const b=a.push("footnote_ref","",0);b.meta={id:l,subId:f,label:h}}return a.pos=c,a.posMax=d,!0}function i(a){let s,d,p,c=!1;const h={};if(!a.env.footnotes||(a.tokens=a.tokens.filter(function(f){return f.type==="footnote_reference_open"?(c=!0,d=[],p=f.meta.label,!1):f.type==="footnote_reference_close"?(c=!1,h[":"+p]=d,!1):(c&&d.push(f),!c)}),!a.env.footnotes.list))return;const l=a.env.footnotes.list;a.tokens.push(new a.Token("footnote_block_open","",1));for(let f=0,b=l.length;f<b;f++){const m=new a.Token("footnote_open","",1);if(m.meta={id:f,label:l[f].label},a.tokens.push(m),l[f].tokens){s=[];const y=new a.Token("paragraph_open","p",1);y.block=!0,s.push(y);const x=new a.Token("inline","",0);x.children=l[f].tokens,x.content=l[f].content,s.push(x);const w=new a.Token("paragraph_close","p",-1);w.block=!0,s.push(w)}else l[f].label&&(s=h[`:${l[f].label}`]);s&&(a.tokens=a.tokens.concat(s));let g;a.tokens[a.tokens.length-1].type==="paragraph_close"?g=a.tokens.pop():g=null;const k=l[f].count>0?l[f].count:1;for(let y=0;y<k;y++){const x=new a.Token("footnote_anchor","",0);x.meta={id:f,subId:y,label:l[f].label},a.tokens.push(x)}g&&a.tokens.push(g),a.tokens.push(new a.Token("footnote_close","",-1))}a.tokens.push(new a.Token("footnote_block_close","",-1))}e.block.ruler.before("reference","footnote_def",t,{alt:["paragraph","reference"]}),e.inline.ruler.after("image","footnote_inline",r),e.inline.ruler.after("footnote_inline","footnote_ref",o),e.core.ruler.after("inline","footnote_tail",i)}var hu,fn;function Aa(){if(fn)return hu;fn=1;var e=!0,u=!1,n=!1;hu=function(b,m){m&&(e=!m.enabled,u=!!m.label,n=!!m.labelAfter),b.core.ruler.after("inline","github-task-lists",function(g){for(var k=g.tokens,y=2;y<k.length;y++)o(k,y)&&(i(k[y],g.Token),t(k[y-2],"class","task-list-item"+(e?"":" enabled")),t(k[r(k,y-2)],"class","contains-task-list"))})};function t(b,m,g){var k=b.attrIndex(m),y=[m,g];k<0?b.attrPush(y):b.attrs[k]=y}function r(b,m){for(var g=b[m].level-1,k=m-1;k>=0;k--)if(b[k].level===g)return k;return-1}function o(b,m){return c(b[m])&&h(b[m-1])&&l(b[m-2])&&f(b[m])}function i(b,m){if(b.children.unshift(a(b,m)),b.children[1].content=b.children[1].content.slice(3),b.content=b.content.slice(3),u)if(n){b.children.pop();var g="task-item-"+Math.ceil(Math.random()*(1e4*1e3)-1e3);b.children[0].content=b.children[0].content.slice(0,-1)+' id="'+g+'">',b.children.push(p(b.content,g,m))}else b.children.unshift(s(m)),b.children.push(d(m))}function a(b,m){var g=new m("html_inline","",0),k=e?' disabled="" ':"";return b.content.indexOf("[ ] ")===0?g.content='<input class="task-list-item-checkbox"'+k+'type="checkbox">':(b.content.indexOf("[x] ")===0||b.content.indexOf("[X] ")===0)&&(g.content='<input class="task-list-item-checkbox" checked=""'+k+'type="checkbox">'),g}function s(b){var m=new b("html_inline","",0);return m.content="<label>",m}function d(b){var m=new b("html_inline","",0);return m.content="</label>",m}function p(b,m,g){var k=new g("html_inline","",0);return k.content='<label class="task-list-item-label" for="'+m+'">'+b+"</label>",k.attrs=[{for:m}],k}function c(b){return b.type==="inline"}function h(b){return b.type==="paragraph_open"}function l(b){return b.type==="list_item_open"}function f(b){return b.content.indexOf("[ ] ")===0||b.content.indexOf("[x] ")===0||b.content.indexOf("[X] ")===0}return hu}var Fa=Aa();const Sa=Ke(Fa),Ta={note:'<svg class="octicon octicon-info mr-2" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8Zm8-6.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13ZM6.5 7.75A.75.75 0 0 1 7.25 7h1a.75.75 0 0 1 .75.75v2.75h.25a.75.75 0 0 1 0 1.5h-2a.75.75 0 0 1 0-1.5h.25v-2h-.25a.75.75 0 0 1-.75-.75ZM8 6a1 1 0 1 1 0-2 1 1 0 0 1 0 2Z"></path></svg>',tip:'<svg class="octicon octicon-light-bulb mr-2" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="M8 1.5c-2.363 0-4 1.69-4 3.75 0 .984.424 1.625.984 2.304l.214.253c.223.264.47.556.673.848.284.411.537.896.621 1.49a.75.75 0 0 1-1.484.211c-.04-.282-.163-.547-.37-.847a8.456 8.456 0 0 0-.542-.68c-.084-.1-.173-.205-.268-.32C3.201 7.75 2.5 6.766 2.5 5.25 2.5 2.31 4.863 0 8 0s5.5 2.31 5.5 5.25c0 1.516-.701 2.5-1.328 3.259-.095.115-.184.22-.268.319-.207.245-.383.453-.541.681-.208.3-.33.565-.37.847a.751.751 0 0 1-1.485-.212c.084-.593.337-1.078.621-1.489.203-.292.45-.584.673-.848.075-.088.147-.173.213-.253.561-.679.985-1.32.985-2.304 0-2.06-1.637-3.75-4-3.75ZM5.75 12h4.5a.75.75 0 0 1 0 1.5h-4.5a.75.75 0 0 1 0-1.5ZM6 15.25a.75.75 0 0 1 .75-.75h2.5a.75.75 0 0 1 0 1.5h-2.5a.75.75 0 0 1-.75-.75Z"></path></svg>',important:'<svg class="octicon octicon-report mr-2" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="M0 1.75C0 .784.784 0 1.75 0h12.5C15.216 0 16 .784 16 1.75v9.5A1.75 1.75 0 0 1 14.25 13H8.06l-2.573 2.573A1.458 1.458 0 0 1 3 14.543V13H1.75A1.75 1.75 0 0 1 0 11.25Zm1.75-.25a.25.25 0 0 0-.25.25v9.5c0 .138.112.25.25.25h2a.75.75 0 0 1 .75.75v2.19l2.72-2.72a.749.749 0 0 1 .53-.22h6.5a.25.25 0 0 0 .25-.25v-9.5a.25.25 0 0 0-.25-.25Zm7 2.25v2.5a.75.75 0 0 1-1.5 0v-2.5a.75.75 0 0 1 1.5 0ZM9 9a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"></path></svg>',warning:'<svg class="octicon octicon-alert mr-2" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="M6.457 1.047c.659-1.234 2.427-1.234 3.086 0l6.082 11.378A1.75 1.75 0 0 1 14.082 15H1.918a1.75 1.75 0 0 1-1.543-2.575Zm1.763.707a.25.25 0 0 0-.44 0L1.698 13.132a.25.25 0 0 0 .22.368h12.164a.25.25 0 0 0 .22-.368Zm.53 3.996v2.5a.75.75 0 0 1-1.5 0v-2.5a.75.75 0 0 1 1.5 0ZM9 11a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"></path></svg>',caution:'<svg class="octicon octicon-stop mr-2" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="M4.47.22A.749.749 0 0 1 5 0h6c.199 0 .389.079.53.22l4.25 4.25c.141.14.22.331.22.53v6a.749.749 0 0 1-.22.53l-4.25 4.25A.749.749 0 0 1 11 16H5a.749.749 0 0 1-.53-.22L.22 11.53A.749.749 0 0 1 0 11V5c0-.199.079-.389.22-.53Zm.84 1.28L1.5 5.31v5.38l3.81 3.81h5.38l3.81-3.81V5.31L10.69 1.5ZM8 4a.75.75 0 0 1 .75.75v3.5a.75.75 0 0 1-1.5 0v-3.5A.75.75 0 0 1 8 4Zm0 8a1 1 0 1 1 0-2 1 1 0 0 1 0 2Z"></path></svg>'},Ma=(e,u={})=>{const{markers:n=["TIP","NOTE","IMPORTANT","WARNING","CAUTION"],icons:t=Ta,matchCaseSensitive:r=!1,titles:o={},classPrefix:i="markdown-alert"}=u,a=n==="*"?"\\w+":n.join("|"),s=new RegExp(`^\\\\?\\[\\!(${a})\\]([^\\n\\r]*)`,r?"":"i");e.core.ruler.after("block","github-alerts",d=>{const p=d.tokens;for(let c=0;c<p.length;c++)if(p[c].type==="blockquote_open"){const h=p[c],l=c;for(;p[c]?.type!=="blockquote_close"&&c<=p.length;)c+=1;const f=p[c],b=c,m=p.slice(l,b+1).find(w=>w.type==="inline");if(!m)continue;const g=m.content.match(s);if(!g)continue;const k=g[1].toLowerCase(),y=g[2].trim()||(o[k]??Ia(k)),x=t[k]??"";m.content=m.content.slice(g[0].length).trimStart(),h.type="alert_open",h.tag="div",h.meta={title:y,type:k,icon:x},f.type="alert_close",f.tag="div"}}),e.renderer.rules.alert_open=function(d,p){const{title:c,type:h,icon:l}=d[p].meta;return`<div class="${i} ${i}-${h}"><p class="${i}-title">${l}${c}</p>`}};function Ia(e){return e.charAt(0).toUpperCase()+e.slice(1)}var pu,hn;function za(){return hn||(hn=1,pu=function(u,n){var t=3,r="-",o=r.charCodeAt(0),i=r.length;function a(s,d,p,c){var h,l,f,b,m,g,k,y=!1,x=s.bMarks[d]+s.tShift[d],w=s.eMarks[d];if(d!==0||o!==s.src.charCodeAt(0))return!1;for(h=x+1;h<=w;h++)if(r[(h-x)%i]!==s.src[h]){k=h+1;break}if(f=Math.floor((h-x)/i),f<t)return!1;if(h-=(h-x)%i,c)return!0;for(l=d;l++,!(l>=p||s.src.slice(x,w)==="..."||(x=s.bMarks[l]+s.tShift[l],w=s.eMarks[l],x<w&&s.sCount[l]<s.blkIndent));)if(o===s.src.charCodeAt(x)&&!(s.sCount[l]-s.blkIndent>=4)){for(h=x+1;h<=w&&r[(h-x)%i]===s.src[h];h++);if(!(Math.floor((h-x)/i)<f)&&(h-=(h-x)%i,h=s.skipSpaces(h),!(h<w))){y=!0;break}}return m=s.parentType,g=s.lineMax,s.parentType="container",s.lineMax=l,b=s.push("front_matter",null,0),b.hidden=!0,b.markup=s.src.slice(d,h),b.block=!0,b.map=[d,l+(y?1:0)],b.meta=s.src.slice(k,x-1),s.parentType=m,s.lineMax=g,s.line=l+(y?1:0),n(b.meta),!0}u.block.ruler.before("table","front_matter",a,{alt:["paragraph","reference","blockquote","list"]})}),pu}var Ra=za();const Pa=Ke(Ra);async function Ba(e){let u=Oa;return()=>{let n="";e.use(Pa,t=>{const r=La(t,u);r!==void 0?n=Na(r,e.utils.escapeHtml):n=""}),e.renderer.rules.front_matter=(t,r,o,i,a)=>n===""?"":`<table class="markdown-frontMatter"${a.renderAttrs(t[r])}>
${n}
</table>
...
`)}function nt(e="auto"){return[h0,...Qe(e,p0,b0)].join(`
...
`,Ge=document.body,ye=document.createElement("div"),z=document.createElement("div"),kn=Be("* { cursor: col-resize }",!1);var G=(e=>(e[e.edit=0]="edit",e[e.sideBySide=1]="sideBySide",e[e.preview=2]="preview",e))(G||{});function U0(){Be(G0),Be(ut()),Be(nt());const e=document.createElement("div");e.className=ne.dividerViewClass,ye.appendChild(e),ye.className=ne.gutterViewClass,Ge.appendChild(ye),z.className=ne.previewPaneClass,Ge.appendChild(z),document.addEventListener("keydown",t=>{t.metaKey&&t.key==="a"&&document.activeElement!==D.MarkEdit.editorView.contentDOM&&Et(z)}),new MutationObserver(yn).observe(z,{attributes:!0,attributeFilter:["style","class"]}),matchMedia("(prefers-color-scheme: dark)").addEventListener("change",()=>{yn(),document.querySelector(".mermaid")!==null&&eu()}),typeof D.MarkEdit.getFileInfo=="function"&&z.addEventListener("click",Y0)}function Ye(e,u=!0){const n=N();be.viewMode=e,e!==n&&localStorage.setItem(Xe.viewModeCacheKey,String(e));const t=D.MarkEdit.editorView;e===0?t.focus():e===2&&t.contentDOM.blur(),e===1?(Ge.classList.add(ne.containerClass),be.splitter??=H0({columnGutters:[{track:1,element:ye}],minSize:150,onDragStart:()=>kn.disabled=!1,onDragEnd:()=>kn.disabled=!0})):(Ge.classList.remove(ne.containerClass),be.splitter?.destroy(),be.splitter=void 0),e===2?z.classList.add("overlay"):z.classList.remove("overlay"),u&&eu()}function V0(){const e=[0,...Ga.map(t=>{switch(t){case"side-by-side":return 1;case"preview":return 2;default:return}}).filter(t=>t!==void 0)],u=e.indexOf(N()),n=u===-1?0:(u+1)%e.length;Ye(e[n])}function Z0(){const e=localStorage.getItem(Xe.viewModeCacheKey);if(e===null)return;const u=Number(e);N()!==u&&Ye(u,!0)}function N(){return be.viewMode}async function eu(){if(N()===0)return;const e=F0(await nu());z.innerHTML=e,v0(()=>{Cu(it(),uu(),!1);const u=localStorage.getItem(Xe.previewPageZoomKey);u!==null&&(z.style.zoom=u)})}function W0(e){if(N()===0||N()===1&&D.MarkEdit.editorView.hasFocus||!e.metaKey||e.ctrlKey||e.altKey||e.shiftKey)return;const u=Number(z.style.zoom)||1,n=t=>String(Math.min(Math.max(t,.5),3));switch(e.key){case"-":z.style.zoom=n(u-.1);break;case"=":z.style.zoom=n(u+.1);break;case"0":z.style.zoom="1";break;default:return}localStorage.setItem(Xe.previewPageZoomKey,z.style.zoom),e.preventDefault(),e.stopPropagation()}function J0(){st(!1)}function K0(){st(!0)}async function Q0(){const e=await nu(!1);await navigator.clipboard.writeText(e)}async function X0(){const e=await nu(!1),u=new ClipboardItem({"text/html":new Blob([e],{type:"text/html"}),"text/plain":new Blob([z.innerText],{type:"text/plain"})});await navigator.clipboard.write([u])}function it(){return D.MarkEdit.editorView.scrollDOM}function uu(){return z}async function ct(e){const u=await nu(!1);return e?await _0(u):u}async function nu(e=!0){const u=D.MarkEdit.editorAPI.getText();return await w0(u,e)}function yn(){const e=getComputedStyle(z).backgroundColor;ye.style.background=`linear-gradient(to right, transparent 50%, ${e} 50%)`}async function st(e){const u=await(async()=>{const t=await D.MarkEdit.getFileInfo();return t===void 0?`${F("untitled")}.html`:`${_t(t.filePath)}.html`})(),n=await ct(e);D.MarkEdit.showSavePanel({fileName:u,string:n})}async function Y0(e){if(!(e.target instanceof Element))return;const u=e.target.closest("a");if(u===null)return;const n=u.getAttribute("href");if(!n?.startsWith("../"))return;const t=(await D.MarkEdit.getFileInfo())?.parentPath;if(t!==void 0){e.preventDefault(),e.stopPropagation();try{const r=_n(t,decodeURIComponent(n));await D.MarkEdit.openFile(r)}catch(r){console.error("Failed to open file:",r)}}}const be={viewMode:0,splitter:void 0};async function xn(){if(_u==="never")return;const e=Date.now(),u=Number(localStorage.getItem(xe.lastCheckCacheKey)??"0");if(e-u<2592e5)return;localStorage.setItem(xe.lastCheckCacheKey,String(e));const t=await(await fetch(xe.latestReleaseURL)).json();t.name!=="1.7.1"&&(ft().has(t.name)||(_u==="quiet"?(Eu.pendingRelease=t,lt(t)):ei(t)))}function lt(e=Eu.pendingRelease){if(e===void 0)return;const u=document.querySelector(`.${ne.updatePillClass}`);if(u!==null){if(u.dataset.releaseName===e.name)return u;u.remove()}const n=document.createElement("button");return n.dataset.releaseName=e.name,n.className=ne.updatePillClass,n.textContent=F("update"),n.style.display=N()===G.edit?"none":"",n.addEventListener("webkitmouseforcedown",t=>{t.preventDefault()}),n.addEventListener("click",()=>{const{title:t,actions:r}=dt(e,()=>{Eu.pendingRelease=void 0,n.remove()}),o=n.getBoundingClientRect(),i={x:o.left,y:o.bottom+10};D.MarkEdit.showContextMenu([{title:t},{separator:!0},...r],i)}),document.body.appendChild(n),n}async function ei(e){const{title:u,actions:n}=dt(e),t=await D.MarkEdit.showAlert({title:u,message:e.body,buttons:n.map(r=>r.title)});n[t]?.action?.()}function dt(e,u=()=>{}){const n=`MarkEdit-preview ${e.name} ${F("newVersionAvailable")}`,t=[{title:F("viewReleasePage"),action:()=>{open(e.html_url),u()}},{title:F("remindMeLater"),action:u},{title:F("skipThisVersion"),action:()=>{const r=ft();r.add(e.name),localStorage.setItem(xe.skippedCacheKey,JSON.stringify([...r])),u()}}];return{title:n,actions:t}}function ft(){const e=localStorage.getItem(xe.skippedCacheKey);return new Set(JSON.parse(e??"[]"))}const xe={latestReleaseURL:"https://api.github.com/repos/MarkEdit-app/MarkEdit-preview/releases/latest",lastCheckCacheKey:"updater.last-check-time",skippedCacheKey:"updater.skipped-versions"},Eu={pendingRelease:void 0};var Oe={exports:{}};var ui=Oe.exports,wn;function ni(){return wn||(wn=1,(function(e,u){(function(n,t){e.exports=t()})(ui,(function(){var n=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(d){return typeof d}:function(d){return d&&typeof Symbol=="function"&&d.constructor===Symbol&&d!==Symbol.prototype?"symbol":typeof d},t=function(d,p){if(!(d instanceof p))throw new TypeError("Cannot call a class as a function")},r=(function(){function d(p,c){for(var h=0;h<c.length;h++){var l=c[h];l.enumerable=l.enumerable||!1,l.configurable=!0,"value"in l&&(l.writable=!0),Object.defineProperty(p,l.key,l)}}return function(p,c,h){return c&&d(p.prototype,c),h&&d(p,h),p}})(),o=Object.assign||function(d){for(var p=1;p<arguments.length;p++){var c=arguments[p];for(var h in c)Object.prototype.hasOwnProperty.call(c,h)&&(d[h]=c[h])}return d},i=(function(){function d(p){var c=arguments.length>1&&arguments[1]!==void 0?arguments[1]:!0,h=arguments.length>2&&arguments[2]!==void 0?arguments[2]:[],l=arguments.length>3&&arguments[3]!==void 0?arguments[3]:5e3;t(this,d),this.ctx=p,this.iframes=c,this.exclude=h,this.iframesTimeout=l}return r(d,[{key:"getContexts",value:function(){var c=void 0,h=[];return typeof this.ctx>"u"||!this.ctx?c=[]:NodeList.prototype.isPrototypeOf(this.ctx)?c=Array.prototype.slice.call(this.ctx):Array.isArray(this.ctx)?c=this.ctx:typeof this.ctx=="string"?c=Array.prototype.slice.call(document.querySelectorAll(this.ctx)):c=[this.ctx],c.forEach(function(l){var f=h.filter(function(b){return b.contains(l)}).length>0;h.indexOf(l)===-1&&!f&&h.push(l)}),h}},{key:"getIframeContents",value:function(c,h){var l=arguments.length>2&&arguments[2]!==void 0?arguments[2]:function(){},f=void 0;try{var b=c.contentWindow;if(f=b.document,!b||!f)throw new Error("iframe inaccessible")}catch{l()}f&&h(f)}},{key:"isIframeBlank",value:function(c){var h="about:blank",l=c.getAttribute("src").trim(),f=c.contentWindow.location.href;return f===h&&l!==h&&l}},{key:"observeIframeLoad",value:function(c,h,l){var f=this,b=!1,m=null,g=function k(){if(!b){b=!0,clearTimeout(m);try{f.isIframeBlank(c)||(c.removeEventListener("load",k),f.getIframeContents(c,h,l))}catch{l()}}};c.addEventListener("load",g),m=setTimeout(g,this.iframesTimeout)}},{key:"onIframeReady",value:function(c,h,l){try{c.contentWindow.document.readyState==="complete"?this.isIframeBlank(c)?this.observeIframeLoad(c,h,l):this.getIframeContents(c,h,l):this.observeIframeLoad(c,h,l)}catch{l()}}},{key:"waitForIframes",value:function(c,h){var l=this,f=0;this.forEachIframe(c,function(){return!0},function(b){f++,l.waitForIframes(b.querySelector("html"),function(){--f||h()})},function(b){b||h()})}},{key:"forEachIframe",value:function(c,h,l){var f=this,b=arguments.length>3&&arguments[3]!==void 0?arguments[3]:function(){},m=c.querySelectorAll("iframe"),g=m.length,k=0;m=Array.prototype.slice.call(m);var y=function(){--g<=0&&b(k)};g||y(),m.forEach(function(x){d.matches(x,f.exclude)?y():f.onIframeReady(x,function(w){h(x)&&(k++,l(w)),y()},y)})}},{key:"createIterator",value:function(c,h,l){return document.createNodeIterator(c,h,l,!1)}},{key:"createInstanceOnIframe",value:function(c){return new d(c.querySelector("html"),this.iframes)}},{key:"compareNodeIframe",value:function(c,h,l){var f=c.compareDocumentPosition(l),b=Node.DOCUMENT_POSITION_PRECEDING;if(f&b)if(h!==null){var m=h.compareDocumentPosition(l),g=Node.DOCUMENT_POSITION_FOLLOWING;if(m&g)return!0}else return!0;return!1}},{key:"getIteratorNode",value:function(c){var h=c.previousNode(),l=void 0;return h===null?l=c.nextNode():l=c.nextNode()&&c.nextNode(),{prevNode:h,node:l}}},{key:"checkIframeFilter",value:function(c,h,l,f){var b=!1,m=!1;return f.forEach(function(g,k){g.val===l&&(b=k,m=g.handled)}),this.compareNodeIframe(c,h,l)?(b===!1&&!m?f.push({val:l,handled:!0}):b!==!1&&!m&&(f[b].handled=!0),!0):(b===!1&&f.push({val:l,handled:!1}),!1)}},{key:"handleOpenIframes",value:function(c,h,l,f){var b=this;c.forEach(function(m){m.handled||b.getIframeContents(m.val,function(g){b.createInstanceOnIframe(g).forEachNode(h,l,f)})})}},{key:"iterateThroughNodes",value:function(c,h,l,f,b){for(var m=this,g=this.createIterator(h,c,f),k=[],y=[],x=void 0,w=void 0,v=function(){var C=m.getIteratorNode(g);return w=C.prevNode,x=C.node,x};v();)this.iframes&&this.forEachIframe(h,function(_){return m.checkIframeFilter(x,w,_,k)},function(_){m.createInstanceOnIframe(_).forEachNode(c,function(C){return y.push(C)},f)}),y.push(x);y.forEach(function(_){l(_)}),this.iframes&&this.handleOpenIframes(k,c,l,f),b()}},{key:"forEachNode",value:function(c,h,l){var f=this,b=arguments.length>3&&arguments[3]!==void 0?arguments[3]:function(){},m=this.getContexts(),g=m.length;g||b(),m.forEach(function(k){var y=function(){f.iterateThroughNodes(c,k,h,l,function(){--g<=0&&b()})};f.iframes?f.waitForIframes(k,y):y()})}}],[{key:"matches",value:function(c,h){var l=typeof h=="string"?[h]:h,f=c.matches||c.matchesSelector||c.msMatchesSelector||c.mozMatchesSelector||c.oMatchesSelector||c.webkitMatchesSelector;if(f){var b=!1;return l.every(function(m){return f.call(c,m)?(b=!0,!1):!0}),b}else return!1}}]),d})(),a=(function(){function d(p){t(this,d),this.ctx=p,this.ie=!1;var c=window.navigator.userAgent;(c.indexOf("MSIE")>-1||c.indexOf("Trident")>-1)&&(this.ie=!0)}return r(d,[{key:"log",value:function(c){var h=arguments.length>1&&arguments[1]!==void 0?arguments[1]:"debug",l=this.opt.log;this.opt.debug&&(typeof l>"u"?"undefined":n(l))==="object"&&typeof l[h]=="function"&&l[h]("mark.js: "+c)}},{key:"escapeStr",value:function(c){return c.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g,"\\$&")}},{key:"createRegExp",value:function(c){return this.opt.wildcards!=="disabled"&&(c=this.setupWildcardsRegExp(c)),c=this.escapeStr(c),Object.keys(this.opt.synonyms).length&&(c=this.createSynonymsRegExp(c)),(this.opt.ignoreJoiners||this.opt.ignorePunctuation.length)&&(c=this.setupIgnoreJoinersRegExp(c)),this.opt.diacritics&&(c=this.createDiacriticsRegExp(c)),c=this.createMergedBlanksRegExp(c),(this.opt.ignoreJoiners||this.opt.ignorePunctuation.length)&&(c=this.createJoinersRegExp(c)),this.opt.wildcards!=="disabled"&&(c=this.createWildcardsRegExp(c)),c=this.createAccuracyRegExp(c),c}},{key:"createSynonymsRegExp",value:function(c){var h=this.opt.synonyms,l=this.opt.caseSensitive?"":"i",f=this.opt.ignoreJoiners||this.opt.ignorePunctuation.length?"\0":"";for(var b in h)if(h.hasOwnProperty(b)){var m=h[b],g=this.opt.wildcards!=="disabled"?this.setupWildcardsRegExp(b):this.escapeStr(b),k=this.opt.wildcards!=="disabled"?this.setupWildcardsRegExp(m):this.escapeStr(m);g!==""&&k!==""&&(c=c.replace(new RegExp("("+this.escapeStr(g)+"|"+this.escapeStr(k)+")","gm"+l),f+("("+this.processSynomyms(g)+"|")+(this.processSynomyms(k)+")")+f))}return c}},{key:"processSynomyms",value:function(c){return(this.opt.ignoreJoiners||this.opt.ignorePunctuation.length)&&(c=this.setupIgnoreJoinersRegExp(c)),c}},{key:"setupWildcardsRegExp",value:function(c){return c=c.replace(/(?:\\)*\?/g,function(h){return h.charAt(0)==="\\"?"?":""}),c.replace(/(?:\\)*\*/g,function(h){return h.charAt(0)==="\\"?"*":""})}},{key:"createWildcardsRegExp",value:function(c){var h=this.opt.wildcards==="withSpaces";return c.replace(/\u0001/g,h?"[\\S\\s]?":"\\S?").replace(/\u0002/g,h?"[\\S\\s]*?":"\\S*")}},{key:"setupIgnoreJoinersRegExp",value:function(c){return c.replace(/[^(|)\\]/g,function(h,l,f){var b=f.charAt(l+1);return/[(|)\\]/.test(b)||b===""?h:h+"\0"})}},{key:"createJoinersRegExp",value:function(c){var h=[],l=this.opt.ignorePunctuation;return Array.isArray(l)&&l.length&&h.push(this.escapeStr(l.join(""))),this.opt.ignoreJoiners&&h.push("\\u00ad\\u200b\\u200c\\u200d"),h.length?c.split(/\u0000+/).join("["+h.join("")+"]*"):c}},{key:"createDiacriticsRegExp",value:function(c){var h=this.opt.caseSensitive?"":"i",l=this.opt.caseSensitive?["aàáảãạăằắẳẵặâầấẩẫậäåāą","AÀÁẢÃẠĂẰẮẲẴẶÂẦẤẨẪẬÄÅĀĄ","cçćč","CÇĆČ","dđď","DĐĎ","eèéẻẽẹêềếểễệëěēę","EÈÉẺẼẸÊỀẾỂỄỆËĚĒĘ","iìíỉĩịîïī","IÌÍỈĨỊÎÏĪ","lł","LŁ","nñňń","NÑŇŃ","oòóỏõọôồốổỗộơởỡớờợöøō","OÒÓỎÕỌÔỒỐỔỖỘƠỞỠỚỜỢÖØŌ","rř","RŘ","sšśșş","SŠŚȘŞ","tťțţ","TŤȚŢ","uùúủũụưừứửữựûüůū","UÙÚỦŨỤƯỪỨỬỮỰÛÜŮŪ","yýỳỷỹỵÿ","YÝỲỶỸỴŸ","zžżź","ZŽŻŹ"]:["aàáảãạăằắẳẵặâầấẩẫậäåāąAÀÁẢÃẠĂẰẮẲẴẶÂẦẤẨẪẬÄÅĀĄ","cçćčCÇĆČ","dđďDĐĎ","eèéẻẽẹêềếểễệëěēęEÈÉẺẼẸÊỀẾỂỄỆËĚĒĘ","iìíỉĩịîïīIÌÍỈĨỊÎÏĪ","lłLŁ","nñňńNÑŇŃ","oòóỏõọôồốổỗộơởỡớờợöøōOÒÓỎÕỌÔỒỐỔỖỘƠỞỠỚỜỢÖØŌ","rřRŘ","sšśșşSŠŚȘŞ","tťțţTŤȚŢ","uùúủũụưừứửữựûüůūUÙÚỦŨỤƯỪỨỬỮỰÛÜŮŪ","yýỳỷỹỵÿYÝỲỶỸỴŸ","zžżźZŽŻŹ"],f=[];return c.split("").forEach(function(b){l.every(function(m){if(m.indexOf(b)!==-1){if(f.indexOf(m)>-1)return!1;c=c.replace(new RegExp("["+m+"]","gm"+h),"["+m+"]"),f.push(m)}return!0})}),c}},{key:"createMergedBlanksRegExp",value:function(c){return c.replace(/[\s]+/gmi,"[\\s]+")}},{key:"createAccuracyRegExp",value:function(c){var h=this,l="!\"#$%&'()*+,-./:;<=>?@[\\]^_`{|}~¡¿",f=this.opt.accuracy,b=typeof f=="string"?f:f.value,m=typeof f=="string"?[]:f.limiters,g="";switch(m.forEach(function(k){g+="|"+h.escapeStr(k)}),b){case"partially":default:return"()("+c+")";case"complementary":return g="\\s"+(g||this.escapeStr(l)),"()([^"+g+"]*"+c+"[^"+g+"]*)";case"exactly":return"(^|\\s"+g+")("+c+")(?=$|\\s"+g+")"}}},{key:"getSeparatedKeywords",value:function(c){var h=this,l=[];return c.forEach(function(f){h.opt.separateWordSearch?f.split(" ").forEach(function(b){b.trim()&&l.indexOf(b)===-1&&l.push(b)}):f.trim()&&l.indexOf(f)===-1&&l.push(f)}),{keywords:l.sort(function(f,b){return b.length-f.length}),length:l.length}}},{key:"isNumeric",value:function(c){return Number(parseFloat(c))==c}},{key:"checkRanges",value:function(c){var h=this;if(!Array.isArray(c)||Object.prototype.toString.call(c[0])!=="[object Object]")return this.log("markRanges() will only accept an array of objects"),this.opt.noMatch(c),[];var l=[],f=0;return c.sort(function(b,m){return b.start-m.start}).forEach(function(b){var m=h.callNoMatchOnInvalidRanges(b,f),g=m.start,k=m.end,y=m.valid;y&&(b.start=g,b.length=k-g,l.push(b),f=k)}),l}},{key:"callNoMatchOnInvalidRanges",value:function(c,h){var l=void 0,f=void 0,b=!1;return c&&typeof c.start<"u"?(l=parseInt(c.start,10),f=l+parseInt(c.length,10),this.isNumeric(c.start)&&this.isNumeric(c.length)&&f-h>0&&f-l>0?b=!0:(this.log("Ignoring invalid or overlapping range: "+(""+JSON.stringify(c))),this.opt.noMatch(c))):(this.log("Ignoring invalid range: "+JSON.stringify(c)),this.opt.noMatch(c)),{start:l,end:f,valid:b}}},{key:"checkWhitespaceRanges",value:function(c,h,l){var f=void 0,b=!0,m=l.length,g=h-m,k=parseInt(c.start,10)-g;return k=k>m?m:k,f=k+parseInt(c.length,10),f>m&&(f=m,this.log("End range automatically set to the max value of "+m)),k<0||f-k<0||k>m||f>m?(b=!1,this.log("Invalid range: "+JSON.stringify(c)),this.opt.noMatch(c)):l.substring(k,f).replace(/\s+/g,"")===""&&(b=!1,this.log("Skipping whitespace only range: "+JSON.stringify(c)),this.opt.noMatch(c)),{start:k,end:f,valid:b}}},{key:"getTextNodes",value:function(c){var h=this,l="",f=[];this.iterator.forEachNode(NodeFilter.SHOW_TEXT,function(b){f.push({start:l.length,end:(l+=b.textContent).length,node:b})},function(b){return h.matchesExclude(b.parentNode)?NodeFilter.FILTER_REJECT:NodeFilter.FILTER_ACCEPT},function(){c({value:l,nodes:f})})}},{key:"matchesExclude",value:function(c){return i.matches(c,this.opt.exclude.concat(["script","style","title","head","html"]))}},{key:"wrapRangeInTextNode",value:function(c,h,l){var f=this.opt.element?this.opt.element:"mark",b=c.splitText(h),m=b.splitText(l-h),g=document.createElement(f);return g.setAttribute("data-markjs","true"),this.opt.className&&g.setAttribute("class",this.opt.className),g.textContent=b.textContent,b.parentNode.replaceChild(g,b),m}},{key:"wrapRangeInMappedTextNode",value:function(c,h,l,f,b){var m=this;c.nodes.every(function(g,k){var y=c.nodes[k+1];if(typeof y>"u"||y.start>h){if(!f(g.node))return!1;var x=h-g.start,w=(l>g.end?g.end:l)-g.start,v=c.value.substr(0,g.start),_=c.value.substr(w+g.start);if(g.node=m.wrapRangeInTextNode(g.node,x,w),c.value=v+_,c.nodes.forEach(function(C,I){I>=k&&(c.nodes[I].start>0&&I!==k&&(c.nodes[I].start-=w),c.nodes[I].end-=w)}),l-=w,b(g.node.previousSibling,g.start),l>g.end)h=g.end;else return!1}return!0})}},{key:"wrapMatches",value:function(c,h,l,f,b){var m=this,g=h===0?0:h+1;this.getTextNodes(function(k){k.nodes.forEach(function(y){y=y.node;for(var x=void 0;(x=c.exec(y.textContent))!==null&&x[g]!=="";)if(l(x[g],y)){var w=x.index;if(g!==0)for(var v=1;v<g;v++)w+=x[v].length;y=m.wrapRangeInTextNode(y,w,w+x[g].length),f(y.previousSibling),c.lastIndex=0}}),b()})}},{key:"wrapMatchesAcrossElements",value:function(c,h,l,f,b){var m=this,g=h===0?0:h+1;this.getTextNodes(function(k){for(var y=void 0;(y=c.exec(k.value))!==null&&y[g]!=="";){var x=y.index;if(g!==0)for(var w=1;w<g;w++)x+=y[w].length;var v=x+y[g].length;m.wrapRangeInMappedTextNode(k,x,v,function(_){return l(y[g],_)},function(_,C){c.lastIndex=C,f(_)})}b()})}},{key:"wrapRangeFromIndex",value:function(c,h,l,f){var b=this;this.getTextNodes(function(m){var g=m.value.length;c.forEach(function(k,y){var x=b.checkWhitespaceRanges(k,g,m.value),w=x.start,v=x.end,_=x.valid;_&&b.wrapRangeInMappedTextNode(m,w,v,function(C){return h(C,k,m.value.substring(w,v),y)},function(C){l(C,k)})}),f()})}},{key:"unwrapMatches",value:function(c){for(var h=c.parentNode,l=document.createDocumentFragment();c.firstChild;)l.appendChild(c.removeChild(c.firstChild));h.replaceChild(l,c),this.ie?this.normalizeTextNode(h):h.normalize()}},{key:"normalizeTextNode",value:function(c){if(c){if(c.nodeType===3)for(;c.nextSibling&&c.nextSibling.nodeType===3;)c.nodeValue+=c.nextSibling.nodeValue,c.parentNode.removeChild(c.nextSibling);else this.normalizeTextNode(c.firstChild);this.normalizeTextNode(c.nextSibling)}}},{key:"markRegExp",value:function(c,h){var l=this;this.opt=h,this.log('Searching with expression "'+c+'"');var f=0,b="wrapMatches",m=function(k){f++,l.opt.each(k)};this.opt.acrossElements&&(b="wrapMatchesAcrossElements"),this[b](c,this.opt.ignoreGroups,function(g,k){return l.opt.filter(k,g,f)},m,function(){f===0&&l.opt.noMatch(c),l.opt.done(f)})}},{key:"mark",value:function(c,h){var l=this;this.opt=h;var f=0,b="wrapMatches",m=this.getSeparatedKeywords(typeof c=="string"?[c]:c),g=m.keywords,k=m.length,y=this.opt.caseSensitive?"":"i",x=function w(v){var _=new RegExp(l.createRegExp(v),"gm"+y),C=0;l.log('Searching with expression "'+_+'"'),l[b](_,1,function(I,Y){return l.opt.filter(Y,v,f,C)},function(I){C++,f++,l.opt.each(I)},function(){C===0&&l.opt.noMatch(v),g[k-1]===v?l.opt.done(f):w(g[g.indexOf(v)+1])})};this.opt.acrossElements&&(b="wrapMatchesAcrossElements"),k===0?this.opt.done(f):x(g[0])}},{key:"markRanges",value:function(c,h){var l=this;this.opt=h;var f=0,b=this.checkRanges(c);b&&b.length?(this.log("Starting to mark with the following ranges: "+JSON.stringify(b)),this.wrapRangeFromIndex(b,function(m,g,k,y){return l.opt.filter(m,g,k,y)},function(m,g){f++,l.opt.each(m,g)},function(){l.opt.done(f)})):this.opt.done(f)}},{key:"unmark",value:function(c){var h=this;this.opt=c;var l=this.opt.element?this.opt.element:"*";l+="[data-markjs]",this.opt.className&&(l+="."+this.opt.className),this.log('Removal selector "'+l+'"'),this.iterator.forEachNode(NodeFilter.SHOW_ELEMENT,function(f){h.unwrapMatches(f)},function(f){var b=i.matches(f,l),m=h.matchesExclude(f);return!b||m?NodeFilter.FILTER_REJECT:NodeFilter.FILTER_ACCEPT},this.opt.done)}},{key:"opt",set:function(c){this._opt=o({},{element:"",className:"",exclude:[],iframes:!1,iframesTimeout:5e3,separateWordSearch:!0,diacritics:!0,synonyms:{},accuracy:"partially",acrossElements:!1,caseSensitive:!1,ignoreJoiners:!1,ignoreGroups:0,ignorePunctuation:[],wildcards:"disabled",each:function(){},noMatch:function(){},filter:function(){return!0},done:function(){},debug:!1,log:window.console},c)},get:function(){return this._opt}},{key:"iterator",get:function(){return new i(this.ctx,this.opt.iframes,this.opt.exclude,this.opt.iframesTimeout)}}]),d})();function s(d){var p=this,c=new a(d);return this.mark=function(h,l){return c.mark(h,l),p},this.markRegExp=function(h,l){return c.markRegExp(h,l),p},this.markRanges=function(h,l){return c.markRanges(h,l),p},this.unmark=function(h){return c.unmark(h),p},this}return s}))})(Oe)),Oe.exports}var ti=ni();const ht=Ke(ti),we="markedit-preview-mark",pt="markedit-preview-mark-highlighted";let me=!1,Nu,Z=0,q=[],ve=null,Pe=null;const vn={github:{light:"#fae17d7f",dark:"#f2cc607f"},cobalt:{light:"#cad40f66",dark:"#cad40f66"},dracula:{light:"#ffffff40",dark:"#ffffff40"},minimal:{light:"#fae17d7f",dark:"#f2cc607f"},"night-owl":{light:"#5f7e9779",dark:"#5f7e9779"},"rose-pine":{light:"#6e6a864c",dark:"#6e6a8666"},solarized:{light:"#f4c09d",dark:"#584032"},synthwave84:{light:"#d18616bb",dark:"#d18616bb"},"winter-is-coming":{light:"#cee1f0",dark:"#103362"},xcode:{light:"#e4e4e4",dark:"#545558"}};function ri(e){if(Nu=e,Z=0,e.search.length===0){bt();return}const u=uu();mt(u),ii(u)}function oi(e){q.length!==0&&(Z=e%q.length,gt())}function bt(){ve?.disconnect(),ve=null,Nu=void 0,Z=0,q=[],new ht(uu()).unmark()}function ai(){if(N()===G.preview)return{numberOfItems:q.length,currentIndex:Z}}function mt(e){const u=Nu;if(u===void 0||u.search.length===0||me)return;ci(),me=!0;const{search:n,caseSensitive:t,wholeWord:r,diacriticInsensitive:o,regexp:i}=u,a=new ht(e),s=()=>{q=Array.from(e.querySelectorAll(`.${we}`)),Z=q.length>0?Math.min(Z,q.length-1):0,gt(),me=!1};a.unmark({done:()=>{if(i)try{const d=t?"":"i";a.markRegExp(new RegExp(n,d),{className:we,done:s})}catch{me=!1,Z=0,q=[]}else a.mark(n,{className:we,caseSensitive:t,diacritics:o,separateWordSearch:!1,accuracy:r?"exactly":"partially",done:s})}})}function gt(){const e=N()!==G.sideBySide;q.forEach((u,n)=>{u.classList.toggle(pt,e&&n===Z)}),e&&q.length>0&&q[Z].scrollIntoView({behavior:"smooth",block:"center"})}function ii(e){ve?.disconnect(),ve=new MutationObserver(()=>{me||mt(e)}),ve.observe(e,{childList:!0})}function ci(){Pe===null&&(Pe=document.createElement("style"),document.head.appendChild(Pe));const{light:e,dark:u}=vn[Bu]??vn.github;Pe.textContent=[`.${we} { background: ${e} !important; color: inherit !important; }`,`.${pt} { background: #ffff00 !important; color: #000000 !important; border-radius: 2px; box-shadow: 0px 0px 0px 2px #ffff00, 0px 0px 3px 2px rgba(0, 0, 0, 0.4); }`,"@media (prefers-color-scheme: dark) {",`  .${we} { background: ${u} !important; }`,"}"].join(`
`)}window.__markeditPreviewInitialized__?console.error("MarkEdit Preview has already been initialized. Multiple initializations may cause unexpected behavior."):(U0(),setTimeout(xn,4e3),_u==="quiet"&&setInterval(xn,6048e5),window.__markeditPreviewInitialized__=!0);window.MarkEditGetHtml??=ct;window.__markeditPreviewSPI__={performSearch:ri,setSearchMatchIndex:oi,clearSearch:bt,searchCounterInfo:ai};D.MarkEdit.addMainMenuItem({title:F("viewMode"),icon:vt()?"eye":void 0,children:[{title:F("changeMode"),action:()=>{V0(),qu()},key:pn.key??"V",modifiers:pn.modifiers??["Command"]},{separator:!0},gu(F("editMode"),G.edit),gu(F("sideBySideMode"),G.sideBySide),gu(F("previewMode"),G.preview),{separator:!0},...si(),{separator:!0},{title:`${F("version")} 1.7.1`,action:()=>open("https://github.com/MarkEdit-app/MarkEdit-preview/releases/tag/v1.7.1")},{title:`${F("checkReleases")} (GitHub)`,action:()=>open("https://github.com/MarkEdit-app/MarkEdit-preview/releases/latest")}]});D.MarkEdit.addExtension(wt.EditorView.updateListener.of(e=>{e.docChanged&&(ue.renderUpdater!==void 0&&clearTimeout(ue.renderUpdater),ue.renderUpdater=setTimeout(eu,500))}));D.MarkEdit.onEditorReady(()=>{Ha&&S0(D.MarkEdit.editorView.scrollDOM),Z0(),requestAnimationFrame(async()=>{document.visibilityState==="visible"&&N()===G.preview&&typeof D.MarkEdit.getFileInfo=="function"&&(await D.MarkEdit.getFileInfo())?.filePath===void 0&&D.MarkEdit.editorAPI.getText().length===0&&Ye(G.edit,!1)}),eu(),qu(),M0(it(),uu()),ue.keyDownListener!==void 0&&document.removeEventListener("keydown",ue.keyDownListener),ue.keyDownListener=e=>W0(e),document.addEventListener("keydown",ue.keyDownListener)});function gu(e,u){return{title:e,action:()=>{Ye(u),qu()},state:()=>({isSelected:N()===u})}}function si(){const e=[{title:F("copyHtml"),action:Q0},{title:F("copyRichText"),action:X0}];return typeof D.MarkEdit.showSavePanel>"u"?e:[{title:F("saveCleanHtml"),action:J0},{title:F("saveStyledHtml"),action:K0},...e]}function qu(){const e=lt();e!==void 0&&(e.style.display=N()===G.edit?"none":"")}const ue={renderUpdater:void 0,keyDownListener:void 0};

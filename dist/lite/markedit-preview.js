...
`};ee.image=function(e,n,t,r,o){const u=e[n];return u.attrs[u.attrIndex("alt")][1]=o.renderInlineAsText(u.children,t,r),o.renderToken(e,n,t)};ee.hardbreak=function(e,n,t){return t.xhtmlOut?`<br />
`:`<br>
`};ee.softbreak=function(e,n,t){return t.breaks?t.xhtmlOut?`<br />
`:`<br>
`:`
`};ee.text=function(e,n){return pe(e[n].content)};ee.html_block=function(e,n){return e[n].content};ee.html_inline=function(e,n){return e[n].content};function qe(){this.rules=Ln({},ee)}qe.prototype.renderAttrs=function(n){let t,r,o;if(!n.attrs)return"";for(o="",t=0,r=n.attrs.length;t<r;t++)o+=" "+pe(n.attrs[t][0])+'="'+pe(n.attrs[t][1])+'"';return o};qe.prototype.renderToken=function(n,t,r){const o=n[t];let u="";if(o.hidden)return"";o.block&&o.nesting!==-1&&t&&n[t-1].hidden&&(u+=`

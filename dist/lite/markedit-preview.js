...
${e.mark.snippet}`),`${e.reason} ${t}`):e.reason}var wn=class extends Error{reason;mark;constructor(e,n){super(),this.name="YAMLException",this.reason=e,this.mark=n,this.message=_r(this,!1),Error.captureStackTrace&&Error.captureStackTrace(this,this.constructor)}toString(e){return`${this.name}: ${_r(this,e)}`}};function qn(e,n,t,r=""){let o=0,u=0;for(let i=0;i<n;i++){const c=e.charCodeAt(i);c===10?(o++,u=i+1):c===13&&(o++,e.charCodeAt(i+1)===10&&i++,u=i+1)}const a={name:r,buffer:e,position:n,line:o,column:n-u};throw a.snippet=Js(a),new wn(t,a)}var Xs=-1;function Er(e){switch(e){case 48:return"\0";case 97:return"\x07";case 98:return"\b";case 116:return"	";case 9:return"	";case 110:return`
`;case 118:return"\v";case 102:return"\f";case 114:return"\r";case 101:return"\x1B";case 32:return" ";case 34:return'"';case 47:return"/";case 92:return"\\";case 78:return"";case 95:return" ";case 76:return"\u2028";case 80:return"\u2029";default:return""}}var Ho=new Array(256),qo=new Array(256);for(let e=0;e<256;e++)Ho[e]=Er(e)?1:0,qo[e]=Er(e);function Qs(e){return e<=65535?String.fromCharCode(e):String.fromCharCode((e-65536>>10)+55296,(e-65536&1023)+56320)}function el(e){return e>=48&&e<=57?e-48:(e|32)-97+10}function nl(e){return e===120?2:e===117?4:8}function _n(e,n,t){let r=0;for(;n<t;){const o=e.charCodeAt(n);if(o===10)r++,n++;else if(o===13)r++,n++,e.charCodeAt(n)===10&&n++;else if(o===32||o===9)n++;else break}return{position:n,breaks:r}}function Ot(e){return e===1?" ":`
`.repeat(e-1)}function tl(e,n,t){let r="",o=n,u=n,a=n;for(;o<t;){const i=e.charCodeAt(o);if(i===10||i===13){r+=e.slice(u,a);const c=_n(e,o,t);r+=Ot(c.breaks),o=u=a=c.position}else o++,i!==32&&i!==9&&(a=o)}return r+e.slice(u,a)}function rl(e,n,t){let r="",o=n,u=n,a=n;for(;o<t;){const i=e.charCodeAt(o);if(i===39)r+=e.slice(u,o)+"'",o+=2,u=a=o;else if(i===10||i===13){r+=e.slice(u,a);const c=_n(e,o,t);r+=Ot(c.breaks),o=u=a=c.position}else o++,i!==32&&i!==9&&(a=o)}return r+e.slice(u,t)}function ol(e,n,t){let r="",o=n,u=n,a=n;for(;o<t;){const i=e.charCodeAt(o);if(i===92){r+=e.slice(u,o),o++;const c=e.charCodeAt(o);if(c===10||c===13)o=_n(e,o,t).position;else if(c<256&&Ho[c])r+=qo[c],o++;else{let l=nl(c),d=0;for(;l>0;l--){o++;const s=el(e.charCodeAt(o));d=(d<<4)+s}r+=Qs(d),o++}u=a=o}else if(i===10||i===13){r+=e.slice(u,a);const c=_n(e,o,t);r+=Ot(c.breaks),o=u=a=c.position}else o++,i!==32&&i!==9&&(a=o)}return r+e.slice(u,t)}function Ar(e,n,t,r,o,u){const a=r<0?0:r,i=e.slice(n,t).replace(/\r\n?/g,`
`),c=i===""?[]:(i.endsWith(`
`)?i.slice(0,-1):i).split(`
...
`);const n=Sn[$n]??Sn.github,t=n.light??n.dark,r=n.dark??n.light;return[Xl,...qt(e,t,r)].join(`
...
`)}const S0=async()=>({renderToString:(...e)=>""}),D0=async()=>({initialize:()=>{},render:async()=>({svg:""}),run:async({postRenderCallback:e})=>e?.()});let T0,Nr,F0=0;async function M0(){const e=await(T0??=D0()),n=matchMedia("(prefers-color-scheme: dark)").matches;return n!==Nr&&(e.initialize({theme:n?"dark":void 0}),Nr=n),e}const V=Z(Kl,{html:!0,breaks:!0,linkify:!0,...Jl}),I0=[];V.use($l());V.use(Ie);V.use(Fc,{matcher:e=>!e.startsWith("#"),attrs:{target:"_blank",rel:"noopener"}});V.use(Bc);V.use($c,{enabled:$t(),label:!0});V.use(Uc);const L0=new Set(["paragraph_open","heading_open","blockquote_open","list_item_open","bullet_list_open","ordered_list_open","fence","code_block","table_open","html_block","front_matter"]),iu=Promise.all(I0).then(()=>{for(const e of L0){const n=V.renderer.rules[e];V.renderer.rules[e]=(t,r,o,u,a)=>{const i=t[r];return u.lineInfo&&i.map?.length===2&&(i.attrSet("data-line-from",String(i.map[0])),i.attrSet("data-line-to",String(i.map[1]-1))),n?n(t,r,o,u,a):a.renderToken(t,r,o)}}for(const e of["fence","code_block"]){const n=V.renderer.rules[e];V.renderer.rules[e]=(t,r,o,u,a)=>`
      <div class="code-copy-wrapper" onmouseenter="this.querySelector('.code-copy-button').style.opacity='1'" onmouseleave="this.querySelector('.code-copy-button').style.opacity='0'">
        ...
        <button title="${L("copyCode")}" aria-label="${L("copyCode")}" class="code-copy-button" onclick="navigator.clipboard.writeText(this.previousElementSibling.dataset.code ?? this.previousElementSibling.innerText); this.style.opacity='0'">
